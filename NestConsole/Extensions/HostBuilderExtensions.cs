...
namespace NestConsole.Extensions
{
    /// <summary>
    ...
    public static class HostBuilderExtensions
    {
        ...
        private const string ConfigureAppConfigurationMethodName = "ConfigureAppConfiguration";
            ...
            this IHostBuilder hostBuilder) where TStartup : class
        {
            ...
            hostBuilder.ConfigureAppConfiguration( configuration => {
                ...
                // Find a method that has this signature: static ConfigureAppConfiguration(IConfigurationBuilder)
                var cfgAppConfigurationMethod = typeof(TStartup).GetMethod(
                    ConfigureAppConfigurationMethodName,
                    BindingFlags.Public | BindingFlags.Static,
                    null,
                    new Type[] { typeof(IConfigurationBuilder) },
                    null);

                cfgAppConfigurationMethod?.Invoke(null, new object[] { configuration });
            });
